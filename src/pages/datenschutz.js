      ...
      <section className="px-4 py-12 mx-auto max-w-7xl min-h-full">
        <div className="container">
          <div className="flex">
            ...
            "
              >
                <li className="font-semibold">Haftung für Inhalte</li>
                <li>
                ...
                <li className="font-semibold mt-5">Haftung für Links</li>
                <li>
                ...
                <li className="font-semibold mt-5">Urheberrecht</li>
                <li>
                ...
                <li className="font-semibold mt-5">Datenschutz</li>
                <li>
                ...
                <li className="font-semibold mt-5">Google Analytics</li>
                <li>
                  ...
                  Sie ermöglicht. Die durch den Cookie erzeugten Informationen
                  über Ihre Benutzung diese Website (einschließlich Ihrer
                ...
                <br/>
                <li>Website Impressum erstellt durch <a href="http://www.impressum-generator.de/" className="text-brandGreen">impressum-generator.de</a> von <a href="https://www.kanzlei-hasselbach.de/ueber-uns/anwaelte/franziska-hasselbach/" className="text-brandGreen">Rechtsanwätin Franziska Hasselbach  </a></li>
              </ul>
            </div>
          </div>
        </div>
